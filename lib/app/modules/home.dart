...
import 'package:taleb/app/components/faderoute.dart';
import 'package:taleb/app/data/models.dart';
import 'package:taleb/app/modules/edit.dart';
import 'package:taleb/app/modules/view.dart';
import 'package:taleb/app/services/database.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget testListItem(Color color) {
    return new NoteCardComponent(
      noteData: NotesModel.random(), onTapAction: (NotesModel noteData) {  },
    );
  }
